...
const { uploadDriverDocuments, uploadDriverComplete, handleUploadError, uploadNone } = require('../utils/multer');
...
router.post('/driver/signup/documents', uploadDriverDocuments, handleUploadError, driverSignupDocuments); // 3. ssn + vehicleTypes + images → docsToken
router.post('/driver/signup/complete', uploadDriverComplete, handleUploadError, driverSignupComplete); // 4. license consent → JWT
